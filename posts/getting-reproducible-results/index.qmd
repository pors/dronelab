...
If you prefer to just use PyTorch, use the [PyTorch notebook](https://colab.research.google.com/drive/1DB--1tnAOGdc5wgHNFc0KE5xhcJFRXgh?usp=sharing){target="_blank"} (Claude generated this based on the Fast.ai version).
